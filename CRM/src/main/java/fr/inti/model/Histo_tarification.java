...
public class Histo_tarification {
	...
	public Histo_tarification() {
		super();
	}

	@Override
	public String toString() {
		return "Histo_tarification [date_debut=" + date_debut + ", date_fin="
				+ date_fin + ", produit=" + produit + "]";
	}

	public Histo_tarification( Date date_debut,
			Date date_fin) {
		super();
