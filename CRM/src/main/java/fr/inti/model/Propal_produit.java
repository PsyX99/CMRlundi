...
public class Propal_produit implements Serializable
{
	/**
	 * 
	 */
	...
	public Propal_produit(int id_Propal_produit, int Quantite,
	...
	public Propal_produit(int Quantite, double Taux_reduction, Produit produit) {
		super();
		quantite = Quantite;
		taux_reduction = Taux_reduction;
		this.produit = produit;
